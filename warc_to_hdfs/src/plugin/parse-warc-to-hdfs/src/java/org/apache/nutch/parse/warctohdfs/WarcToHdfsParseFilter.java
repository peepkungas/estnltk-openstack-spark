...
/** 
 * Convert WARC file contents into HDFS SequenceFiles in format
 * key: domain::path::date
 * value: HTML content of page
 ***/
...
/*		
  		// meta to consider or try  : metadata.CONTENT_LOCATION, metadata.DATE, metadata.FETCH_TIME_KEY, metadata.LAST_MODIFIED
		// meta only contains char encodings
		LOG.info("Metadata count: " + metadata.names().length);
